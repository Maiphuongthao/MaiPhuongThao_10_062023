...
PRIORITY = [("FAIBLE", "Faible"), ("MOYEN", "Moyen"), ("ELEVEE", "Elevée")]
...
class Issues(models.Model):
    ...
    project_id = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name="related_issues"
    )
    ...
    assignee_user_id = models.ForeignKey(
        User, on_delete=models.RESTRICT, related_name="issue_assigned_to"
    )
